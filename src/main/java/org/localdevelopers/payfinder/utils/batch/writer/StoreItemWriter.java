package org.localdevelopers.payfinder.utils.batch.writer;

import com.mongodb.client.result.UpdateResult;
import org.localdevelopers.payfinder.domain.Store;
import org.localdevelopers.payfinder.domain.Store.StoreFields;
...
public class StoreItemWriter extends MongoItemWriter<Store> {
    private static final Logger logger = LoggerFactory.getLogger(StoreItemWriter.class);
